...
//
//public class CorruptComplaintController {
//    @FXML
...
//    }
//    @FXML
//    private ImageView kukuku;
//    @FXML
//    public void initialize() {
//        String url = getClass().getResource("/ku/cs/corruptcomplaint_images/kukuku.jpeg").toExternalForm();
//        kukuku.setImage(new Image(url));
...
//        Complaint complaint = new Complaint(headComplaint,bodyComplaint,bodyComplaint1,"corrupt",user.getName());
