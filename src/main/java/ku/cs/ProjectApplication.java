...
public class ProjectApplication extends Application {
    ...
    private static void configRoute() {
        ...
        FXRouter.when("register",packageStr + "user_register.fxml");
        FXRouter.when("credit", packageStr + "credit.fxml");
        FXRouter.when("home",packageStr + "user_home.fxml");
        FXRouter.when("changepassword",packageStr + "user_change_password.fxml");
        FXRouter.when("normalcomplaint", packageStr + "user_complaint.fxml");
        ...
        FXRouter.when("adminscene",packageStr + "admin_scene.fxml");
        FXRouter.when("officer",packageStr + "officer_home.fxml");
        ...
        FXRouter.when("admincomplaint",packageStr + "admin_report_scene.fxml");
        ...
        FXRouter.when("selected_complaint_detail",packageStr+"user_selected_complaint_detail.fxml");
        FXRouter.when("report_complaint",packageStr+"user_report_complaint.fxml");
        ...
        FXRouter.when("tutorial_student",packageStr+"tutorial_student.fxml");
    }
